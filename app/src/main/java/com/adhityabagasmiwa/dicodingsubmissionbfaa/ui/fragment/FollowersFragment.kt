...
import com.adhityabagasmiwa.dicodingsubmissionbfaa.databinding.FragmentFollowersBinding
...
class FollowersFragment : Fragment() {
    ...
    private fun getData(username: String?) {
        ...
        mainVieModel.setFollowerList(activity!!, username)
        mainVieModel.getFollowerList().observe(activity!!, Observer { results ->
