...
package com.adhityabagasmiwa.dicodingsubmissionbfaa.utils.reminder
...
import com.adhityabagasmiwa.dicodingsubmissionbfaa.ui.activities.SplashScreenActivity
import java.util.*
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun sendNotification(context: Context) {
        val mIntent = Intent(context, SplashScreenActivity::class.java)
